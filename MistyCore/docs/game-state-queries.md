...
## Items worn
`mistyspring.mistycore_PlayerWearing <player> <type> <item> [only worn]`
...
- `mistyspring.mistycore_PlayerWearing Current Hat CustomHat`

This will check if current player's hat has ID CustomHat.


- `mistyspring.mistycore_PlayerWearing Current (S) MyCustomShirt false`
