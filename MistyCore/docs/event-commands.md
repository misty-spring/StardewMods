...
* [New "end" commands](#end-commands)
    ...
    * [island farmhouse](#house--farmhouse)
...
Ends the event and returns to the island farmhouse, on the default entry point.
...
First, you must load the scene to `mistyspring.mistycore/Scenes/<name-of-scene>`.
...
{
  "Action": "Load",
  "Target": "mistyspring.mistycore/Scenes/MyScene",
